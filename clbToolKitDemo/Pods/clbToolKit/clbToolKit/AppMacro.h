...
#define mIsiOS     [[[UIDevice currentDevice] systemVersion] integerValue]
...
#define m5sHight(height)      (mIsiP5 ? height * (1136.0/1334.0) : height)          //5s的高与6的比例
...
#define LXLogResponseString NSLog(@"%@",[[NSString alloc]initWithData:responseObject encoding:NSUTF8StringEncoding]);
